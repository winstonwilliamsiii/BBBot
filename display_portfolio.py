...
print(f"✓ API Key ID: {KALSHI_API_KEY_ID[:20]}..." if KALSHI_API_KEY_ID else "✗ API Key ID: NOT SET")
print(f"✓ Private Key: loaded" if KALSHI_PRIVATE_KEY else "✗ Private Key: NOT SET")
