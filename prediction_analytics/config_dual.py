...
class DemoConfig:
    ...
    MYSQL_PASSWORD = os.getenv("DEMO_MYSQL_PASSWORD", "password")
    MYSQL_DB = os.getenv("DEMO_MYSQL_DB", "Demo_Bots")
...
class Config:
    """Production configuration for Bentley_Bot on port 3306."""
    MYSQL_HOST = os.getenv("MYSQL_HOST", "127.0.0.1")
    MYSQL_PORT = int(os.getenv("MYSQL_PORT", 3306))
    MYSQL_USER = os.getenv("MYSQL_USER", "bentley_user")
    MYSQL_PASSWORD = os.getenv("MYSQL_PASSWORD", "")
    MYSQL_DB = os.getenv("MYSQL_DB", "Bentley_Bot")
