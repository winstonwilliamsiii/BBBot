...
class AltairConfig:
    ...
    airflow_base_url: str = "http://127.0.0.1:8080"
    ...
    def from_env(cls) -> "AltairConfig":
        ...
        return cls(
            ...
            airflow_base_url=str(os.getenv("AIRFLOW_BASE_URL", "http://127.0.0.1:8080")).rstrip("/"),
            ...
            fastapi_base_url=str(os.getenv("ALTAIR_FASTAPI_BASE_URL", os.getenv("CONTROL_CENTER_API_URL", "http://127.0.0.1:5001"))).rstrip("/"),
            dashboard_url=str(os.getenv("BENTLEY_UI_URL", os.getenv("STREAMLIT_PUBLIC_URL", "http://127.0.0.1:8501"))).rstrip("/"),
