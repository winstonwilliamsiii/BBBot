...
# ============================================
try:
    POLYMARKET_API_KEY = st.secrets.get("POLYMARKET_API_KEY", "") or os.getenv("POLYMARKET_API_KEY", "")
    POLYMARKET_SECRET_KEY = st.secrets.get("POLYMARKET_SECRET_KEY", "") or os.getenv("POLYMARKET_SECRET_KEY", "")
except Exception:
